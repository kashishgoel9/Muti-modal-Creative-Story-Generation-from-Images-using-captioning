...
In the second experiment, the stories generated are evaluated. 'Perplexity' is used to evaluate how well the model is able to predict/generate the next word.  
